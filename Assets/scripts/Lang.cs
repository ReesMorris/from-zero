/*
[3] -- This script was not created by us.
...
public class Lang
{
    ...
    */
	public Lang ( string filename, string language, bool web) {
		if (!web) {
			setLanguage(filename, language);
		} else {
			setLanguageWeb(filename, language);
		}
	}
    ...
    */
	public void setLanguage ( string filename, string language) {
		...
		if (Application.isEditor) {
			xml.Load (Application.dataPath + "/Resources/" + filename + ".xml");
		} else {
